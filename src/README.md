...
| <a name="module_kms_key_logs"></a> [kms\_key\_logs](#module\_kms\_key\_logs) | cloudposse/kms-key/aws | 0.12.1 |
| <a name="module_logs"></a> [logs](#module\_logs) | cloudposse/cloudwatch-logs/aws | 0.6.5 |
